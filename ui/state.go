...
// customVisOverlay holds state for the custom visualizer editor overlay.
type customVisOverlay struct {
	visible   bool
	screen    int    // 0=list, 1=text input, 2=effect select
	configs   []CustomVisConfig
	cursor    int
	textBuf   string
	effectIdx int
}
